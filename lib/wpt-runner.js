...
const { SourceFile } = require("./internal/sourcefile");
const {
  AnyHtmlHandler,
  AnyWorkerHandler,
...
function setupServer(testsPath, rootURL) {
  ...
  const routes = [
    [".worker.html", new WorkersHandler(testsPath, rootURL)],
    [".window.html", new WindowHandler(testsPath, rootURL)],
    [".any.html", new AnyHtmlHandler(testsPath, rootURL)],
    [".any.sharedworker.html", new SharedWorkersHandler(testsPath, rootURL)],
    [".any.serviceworker.html", new ServiceWorkersHandler(testsPath, rootURL)],
    [".any.worker.js", new AnyWorkerHandler(testsPath, rootURL)]
  ];
