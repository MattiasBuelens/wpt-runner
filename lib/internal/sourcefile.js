...
const anyVariants = {
  ...
  default: {
    longhand: ["window", "dedicatedworker"]
  },
  window: {
    suffix: ".any.html"
  },
  ...
  sharedworker: {},
  dedicatedworker: {
    suffix: ".any.worker.html"
  },
  worker: {
    longhand: ["dedicatedworker", "sharedworker", "serviceworker"]
  },
  jsshell: {
    suffix: ".any.js"
  }
...
class SourceFile {
  ...
  testPaths() {
    ...
    if (this.nameIsMultiGlobal()) {
      ...
      const testPath = replaceEnd(this.relPath, ".worker.js", ".worker.html");
      paths.push(testPath);
